...
composer-install: ## Installs composer dependencies
	docker compose --file=docker/infrastructure/dev/docker-compose-dev.yml exec backend composer install --optimize-autoloader -q --no-ansi --no-interaction --no-scripts --no-progress --prefer-dist
